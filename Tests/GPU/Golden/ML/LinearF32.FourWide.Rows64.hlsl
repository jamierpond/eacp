...
void computeMain(uint3 threadId : SV_DispatchThreadID, uint3 localThread : SV_GroupThreadID, uint3 groupIndex : SV_GroupID, uint groupLane : SV_GroupIndex)
{
    ...
    float4 t19 = float4(buffer0[t18], buffer0[t18 + 1u], buffer0[t18 + 2u], buffer0[t18 + 3u]);
    v1 = float4((t15 ? (t19).x : 0.0), (t15 ? (t19).y : 0.0), (t15 ? (t19).z : 0.0), (t15 ? (t19).w : 0.0));
    ...
    v4 = float4((t20 ? (t25).x : 0.0), (t20 ? (t25).y : 0.0), (t20 ? (t25).z : 0.0), (t20 ? (t25).w : 0.0));
    bool t26 = (t14 < uniforms.u2);
    uint t27 = (t21 + t16);
    uint t28 = ((((min(t27, t23) * uniforms.u2) + min(t14, t9)) / 4u) * 4u);
    float4 t29 = float4(buffer1[t28], buffer1[t28 + 1u], buffer1[t28 + 2u], buffer1[t28 + 3u]);
    v5 = float4((t26 ? (t29).x : 0.0), (t26 ? (t29).y : 0.0), (t26 ? (t29).z : 0.0), (t26 ? (t29).w : 0.0));
    uint v8 = 0u;
    while ((v8 < uniforms.u2))
    {
        ...
        float4 t38 = float4(buffer0[t37], buffer0[t37 + 1u], buffer0[t37 + 2u], buffer0[t37 + 3u]);
        v0 = float4((t36 ? (t38).x : 0.0), (t36 ? (t38).y : 0.0), (t36 ? (t38).z : 0.0), (t36 ? (t38).w : 0.0));
        uint t39 = (t34 + t13);
        bool t40 = (t39 < uniforms.u2);
        uint t41 = ((((min(t17, t8) * uniforms.u2) + min(t39, t9)) / 4u) * 4u);
        float4 t42 = float4(buffer0[t41], buffer0[t41 + 1u], buffer0[t41 + 2u], buffer0[t41 + 3u]);
        v1 = float4((t40 ? (t42).x : 0.0), (t40 ? (t42).y : 0.0), (t40 ? (t42).z : 0.0), (t40 ? (t42).w : 0.0));
        uint t43 = (t34 + t2);
        bool t44 = (t43 < uniforms.u2);
        uint t45 = ((((min(t22, t23) * uniforms.u2) + min(t43, t9)) / 4u) * 4u);
        float4 t46 = float4(buffer1[t45], buffer1[t45 + 1u], buffer1[t45 + 2u], buffer1[t45 + 3u]);
        v4 = float4((t44 ? (t46).x : 0.0), (t44 ? (t46).y : 0.0), (t44 ? (t46).z : 0.0), (t44 ? (t46).w : 0.0));
        uint t47 = (t34 + t13);
        bool t48 = (t47 < uniforms.u2);
        uint t49 = ((((min(t27, t23) * uniforms.u2) + min(t47, t9)) / 4u) * 4u);
        float4 t50 = float4(buffer1[t49], buffer1[t49 + 1u], buffer1[t49 + 2u], buffer1[t49 + 3u]);
        v5 = float4((t48 ? (t50).x : 0.0), (t48 ? (t50).y : 0.0), (t48 ? (t50).z : 0.0), (t48 ? (t50).w : 0.0));
        uint t51 = (((groupLane / 32u) % 2u) * 32u);
        uint t52 = ((t51 + 0u) * 24u);
        float2 sgm16 = float2(s0[((t52 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t52 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t53 = ((t51 + 8u) * 24u);
        float2 sgm17 = float2(s0[((t53 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t53 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t54 = ((t51 + 16u) * 24u);
        float2 sgm18 = float2(s0[((t54 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t54 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t55 = ((t51 + 24u) * 24u);
        float2 sgm19 = float2(s0[((t55 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t55 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t56 = (((groupLane / 32u) / 2u) * 32u);
        uint t57 = (1536u + t56);
        float2 sgm20 = float2(s0[((t57 + 0u)) + sgmRow * (72u) + sgmColumn], s0[((t57 + 0u)) + sgmRow * (72u) + sgmColumn + 1u]);
        float2 sgm21 = float2(s0[((t57 + 8u)) + sgmRow * (72u) + sgmColumn], s0[((t57 + 8u)) + sgmRow * (72u) + sgmColumn + 1u]);
        float2 sgm22 = float2(s0[((t57 + 16u)) + sgmRow * (72u) + sgmColumn], s0[((t57 + 16u)) + sgmRow * (72u) + sgmColumn + 1u]);
        float2 sgm23 = float2(s0[((t57 + 24u)) + sgmRow * (72u) + sgmColumn], s0[((t57 + 24u)) + sgmRow * (72u) + sgmColumn + 1u]);
        ...
        float2 sgm24 = float2(s0[((t52 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t52 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        float2 sgm25 = float2(s0[((t53 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t53 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        float2 sgm26 = float2(s0[((t54 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t54 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        float2 sgm27 = float2(s0[((t55 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t55 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t58 = (2112u + t56);
        float2 sgm28 = float2(s0[((t58 + 0u)) + sgmRow * (72u) + sgmColumn], s0[((t58 + 0u)) + sgmRow * (72u) + sgmColumn + 1u]);
        float2 sgm29 = float2(s0[((t58 + 8u)) + sgmRow * (72u) + sgmColumn], s0[((t58 + 8u)) + sgmRow * (72u) + sgmColumn + 1u]);
        float2 sgm30 = float2(s0[((t58 + 16u)) + sgmRow * (72u) + sgmColumn], s0[((t58 + 16u)) + sgmRow * (72u) + sgmColumn + 1u]);
        float2 sgm31 = float2(s0[((t58 + 24u)) + sgmRow * (72u) + sgmColumn], s0[((t58 + 24u)) + sgmRow * (72u) + sgmColumn + 1u]);
        for (uint sgm0k = 0u; sgm0k < 8u; ++sgm0k)
        {
    ...
    if ((!(t67)))
    {
        ...
        {
            buffer2[((t70 * uniforms.u1) + t71)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t69)];
        }
        uint t72 = (t68 + 32u);
        uint t73 = (t61 + (t72 / 8u));
        uint t74 = (t65 + (t72 % 8u));
        ...
        {
            buffer2[((t73 * uniforms.u1) + t74)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t72)];
        }
    }
    GroupMemoryBarrierWithGroupSync();
    uint t75 = (t64 + 8u);
    ...
    if ((!(t77)))
    {
        ...
        {
            buffer2[((t80 * uniforms.u1) + t81)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t79)];
        }
        uint t82 = (t78 + 32u);
        uint t83 = (t61 + (t82 / 8u));
        uint t84 = (t75 + (t82 % 8u));
        ...
        {
            buffer2[((t83 * uniforms.u1) + t84)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t82)];
        }
    }
    GroupMemoryBarrierWithGroupSync();
    uint t85 = (t64 + 16u);
    ...
    if ((!(t87)))
    {
        ...
        {
            buffer2[((t90 * uniforms.u1) + t91)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t89)];
        }
        uint t92 = (t88 + 32u);
        uint t93 = (t61 + (t92 / 8u));
        uint t94 = (t85 + (t92 % 8u));
        ...
        {
            buffer2[((t93 * uniforms.u1) + t94)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t92)];
        }
    }
    GroupMemoryBarrierWithGroupSync();
    uint t95 = (t64 + 24u);
    ...
    if ((!(t97)))
    {
        ...
        {
            buffer2[((t100 * uniforms.u1) + t101)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t99)];
        }
        uint t102 = (t98 + 32u);
        ...
        {
            buffer2[((t103 * uniforms.u1) + t104)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t102)];
        }
    }
    GroupMemoryBarrierWithGroupSync();
    uint t105 = (t60 + 8u);
    ...
    if ((!(t107)))
    {
        ...
        {
            buffer2[((t110 * uniforms.u1) + t111)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t109)];
        }
        uint t112 = (t108 + 32u);
        ...
        {
            buffer2[((t113 * uniforms.u1) + t114)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t112)];
        }
    }
    GroupMemoryBarrierWithGroupSync();
    ...
    if ((!(t141)))
    {
        ...
        {
            buffer2[((t144 * uniforms.u1) + t145)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t143)];
        }
        uint t146 = (t142 + 32u);
        ...
        {
            buffer2[((t147 * uniforms.u1) + t148)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t146)];
        }
    }
    GroupMemoryBarrierWithGroupSync();
    ...
    if ((!(t175)))
    {
        ...
        {
            buffer2[((t178 * uniforms.u1) + t179)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t177)];
        }
        uint t180 = (t176 + 32u);
        ...
        {
            buffer2[((t181 * uniforms.u1) + t182)] = s0[((2688u + ((groupLane / 32u) * 64u)) + t180)];
        }
    }
    GroupMemoryBarrierWithGroupSync();
