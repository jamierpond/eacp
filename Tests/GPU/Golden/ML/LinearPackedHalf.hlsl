...
void computeMain(uint3 threadId : SV_DispatchThreadID, uint3 localThread : SV_GroupThreadID, uint3 groupIndex : SV_GroupID, uint groupLane : SV_GroupIndex)
{
    ...
    while ((v0 < uniforms.u2))
    {
        ...
        uint t9 = (t8 + t7);
        s0[((2048u + ((t1 + 0u) * 64u)) + t0)] = (t4 ? eacpReadHalf(asuint(buffer1[(t9 / 2u)]), (t9 % 2u)) : 0.0);
        uint t10 = ((v0 + t1) + 1u);
        bool t11 = (t10 < uniforms.u2);
        uint t12 = min(t10, t6);
        s0[(t2 + 1u)] = (t11 ? buffer0[(t5 + t12)] : 0.0);
        uint t13 = (t8 + t12);
        s0[((2048u + ((t1 + 1u) * 64u)) + t0)] = (t11 ? eacpReadHalf(asuint(buffer1[(t13 / 2u)]), (t13 % 2u)) : 0.0);
        uint t14 = ((v0 + t1) + 2u);
        bool t15 = (t14 < uniforms.u2);
        uint t16 = min(t14, t6);
        s0[(t2 + 2u)] = (t15 ? buffer0[(t5 + t16)] : 0.0);
        uint t17 = (t8 + t16);
        s0[((2048u + ((t1 + 2u) * 64u)) + t0)] = (t15 ? eacpReadHalf(asuint(buffer1[(t17 / 2u)]), (t17 % 2u)) : 0.0);
        uint t18 = ((v0 + t1) + 3u);
        bool t19 = (t18 < uniforms.u2);
        uint t20 = min(t18, t6);
        s0[(t2 + 3u)] = (t19 ? buffer0[(t5 + t20)] : 0.0);
        uint t21 = (t8 + t20);
        s0[((2048u + ((t1 + 3u) * 64u)) + t0)] = (t19 ? eacpReadHalf(asuint(buffer1[(t21 / 2u)]), (t21 % 2u)) : 0.0);
        uint t22 = ((v0 + t1) + 4u);
        bool t23 = (t22 < uniforms.u2);
        uint t24 = min(t22, t6);
        s0[(t2 + 4u)] = (t23 ? buffer0[(t5 + t24)] : 0.0);
        uint t25 = (t8 + t24);
        s0[((2048u + ((t1 + 4u) * 64u)) + t0)] = (t23 ? eacpReadHalf(asuint(buffer1[(t25 / 2u)]), (t25 % 2u)) : 0.0);
        uint t26 = ((v0 + t1) + 5u);
        bool t27 = (t26 < uniforms.u2);
        uint t28 = min(t26, t6);
        s0[(t2 + 5u)] = (t27 ? buffer0[(t5 + t28)] : 0.0);
        uint t29 = (t8 + t28);
        s0[((2048u + ((t1 + 5u) * 64u)) + t0)] = (t27 ? eacpReadHalf(asuint(buffer1[(t29 / 2u)]), (t29 % 2u)) : 0.0);
        uint t30 = ((v0 + t1) + 6u);
        bool t31 = (t30 < uniforms.u2);
        uint t32 = min(t30, t6);
        s0[(t2 + 6u)] = (t31 ? buffer0[(t5 + t32)] : 0.0);
        uint t33 = (t8 + t32);
        s0[((2048u + ((t1 + 6u) * 64u)) + t0)] = (t31 ? eacpReadHalf(asuint(buffer1[(t33 / 2u)]), (t33 % 2u)) : 0.0);
        uint t34 = ((v0 + t1) + 7u);
        bool t35 = (t34 < uniforms.u2);
        uint t36 = min(t34, t6);
        s0[(t2 + 7u)] = (t35 ? buffer0[(t5 + t36)] : 0.0);
        uint t37 = (t8 + t36);
        s0[((2048u + ((t1 + 7u) * 64u)) + t0)] = (t35 ? eacpReadHalf(asuint(buffer1[(t37 / 2u)]), (t37 % 2u)) : 0.0);
        GroupMemoryBarrierWithGroupSync();
        uint t38 = (((groupLane / 32u) % 2u) * 32u);
        uint t39 = ((t38 + 0u) * 32u);
        float2 sgm8 = float2(s0[((t39 + 0u)) + sgmRow * (32u) + sgmColumn], s0[((t39 + 0u)) + sgmRow * (32u) + sgmColumn + 1u]);
        uint t40 = ((t38 + 8u) * 32u);
        float2 sgm9 = float2(s0[((t40 + 0u)) + sgmRow * (32u) + sgmColumn], s0[((t40 + 0u)) + sgmRow * (32u) + sgmColumn + 1u]);
        uint t41 = ((t38 + 16u) * 32u);
        float2 sgm10 = float2(s0[((t41 + 0u)) + sgmRow * (32u) + sgmColumn], s0[((t41 + 0u)) + sgmRow * (32u) + sgmColumn + 1u]);
        uint t42 = ((t38 + 24u) * 32u);
        float2 sgm11 = float2(s0[((t42 + 0u)) + sgmRow * (32u) + sgmColumn], s0[((t42 + 0u)) + sgmRow * (32u) + sgmColumn + 1u]);
        uint t43 = (((groupLane / 32u) / 2u) * 16u);
        uint t44 = (2048u + t43);
        float2 sgm12 = float2(s0[((t44 + 0u)) + sgmRow * (64u) + sgmColumn], s0[((t44 + 0u)) + sgmRow * (64u) + sgmColumn + 1u]);
        float2 sgm13 = float2(s0[((t44 + 8u)) + sgmRow * (64u) + sgmColumn], s0[((t44 + 8u)) + sgmRow * (64u) + sgmColumn + 1u]);
        ...
        float2 sgm14 = float2(s0[((t39 + 8u)) + sgmRow * (32u) + sgmColumn], s0[((t39 + 8u)) + sgmRow * (32u) + sgmColumn + 1u]);
        float2 sgm15 = float2(s0[((t40 + 8u)) + sgmRow * (32u) + sgmColumn], s0[((t40 + 8u)) + sgmRow * (32u) + sgmColumn + 1u]);
        float2 sgm16 = float2(s0[((t41 + 8u)) + sgmRow * (32u) + sgmColumn], s0[((t41 + 8u)) + sgmRow * (32u) + sgmColumn + 1u]);
        float2 sgm17 = float2(s0[((t42 + 8u)) + sgmRow * (32u) + sgmColumn], s0[((t42 + 8u)) + sgmRow * (32u) + sgmColumn + 1u]);
        uint t45 = (2560u + t43);
        float2 sgm18 = float2(s0[((t45 + 0u)) + sgmRow * (64u) + sgmColumn], s0[((t45 + 0u)) + sgmRow * (64u) + sgmColumn + 1u]);
        float2 sgm19 = float2(s0[((t45 + 8u)) + sgmRow * (64u) + sgmColumn], s0[((t45 + 8u)) + sgmRow * (64u) + sgmColumn + 1u]);
        for (uint sgm0k = 0u; sgm0k < 8u; ++sgm0k)
        {
        ...
        float2 sgm20 = float2(s0[((t39 + 16u)) + sgmRow * (32u) + sgmColumn], s0[((t39 + 16u)) + sgmRow * (32u) + sgmColumn + 1u]);
        float2 sgm21 = float2(s0[((t40 + 16u)) + sgmRow * (32u) + sgmColumn], s0[((t40 + 16u)) + sgmRow * (32u) + sgmColumn + 1u]);
        float2 sgm22 = float2(s0[((t41 + 16u)) + sgmRow * (32u) + sgmColumn], s0[((t41 + 16u)) + sgmRow * (32u) + sgmColumn + 1u]);
        float2 sgm23 = float2(s0[((t42 + 16u)) + sgmRow * (32u) + sgmColumn], s0[((t42 + 16u)) + sgmRow * (32u) + sgmColumn + 1u]);
        uint t46 = (3072u + t43);
        float2 sgm24 = float2(s0[((t46 + 0u)) + sgmRow * (64u) + sgmColumn], s0[((t46 + 0u)) + sgmRow * (64u) + sgmColumn + 1u]);
        float2 sgm25 = float2(s0[((t46 + 8u)) + sgmRow * (64u) + sgmColumn], s0[((t46 + 8u)) + sgmRow * (64u) + sgmColumn + 1u]);
        for (uint sgm0k = 0u; sgm0k < 8u; ++sgm0k)
        {
        ...
        float2 sgm26 = float2(s0[((t39 + 24u)) + sgmRow * (32u) + sgmColumn], s0[((t39 + 24u)) + sgmRow * (32u) + sgmColumn + 1u]);
        float2 sgm27 = float2(s0[((t40 + 24u)) + sgmRow * (32u) + sgmColumn], s0[((t40 + 24u)) + sgmRow * (32u) + sgmColumn + 1u]);
        float2 sgm28 = float2(s0[((t41 + 24u)) + sgmRow * (32u) + sgmColumn], s0[((t41 + 24u)) + sgmRow * (32u) + sgmColumn + 1u]);
        float2 sgm29 = float2(s0[((t42 + 24u)) + sgmRow * (32u) + sgmColumn], s0[((t42 + 24u)) + sgmRow * (32u) + sgmColumn + 1u]);
        uint t47 = (3584u + t43);
        float2 sgm30 = float2(s0[((t47 + 0u)) + sgmRow * (64u) + sgmColumn], s0[((t47 + 0u)) + sgmRow * (64u) + sgmColumn + 1u]);
        float2 sgm31 = float2(s0[((t47 + 8u)) + sgmRow * (64u) + sgmColumn], s0[((t47 + 8u)) + sgmRow * (64u) + sgmColumn + 1u]);
        for (uint sgm0k = 0u; sgm0k < 8u; ++sgm0k)
        {
    ...
    GroupMemoryBarrierWithGroupSync();
    uint t48 = (((groupLane / 32u) % 2u) * 32u);
    uint t49 = (t48 + 0u);
    uint t50 = (((groupLane / 32u) / 2u) * 16u);
