...
void main()
{
    ...
    v4 = vec4(((t4 < uniforms.u2) ? buffer1[(t17 + min(t4, t10))] : 0.0), ((t11 < uniforms.u2) ? buffer1[(t17 + min(t11, t10))] : 0.0), ((t12 < uniforms.u2) ? buffer1[(t17 + min(t12, t10))] : 0.0), ((t13 < uniforms.u2) ? buffer1[(t17 + min(t13, t10))] : 0.0));
    uint t18 = (lid.x + 128u);
    uint t19 = ((t18 % 4u) * 4u);
    uint t20 = (0u + t19);
    uint t21 = (t20 + 0u);
    ...
    uint t26 = (t20 + 2u);
    uint t27 = (t20 + 3u);
    v5 = vec4(((t21 < uniforms.u2) ? buffer1[(t24 + min(t21, t10))] : 0.0), ((t25 < uniforms.u2) ? buffer1[(t24 + min(t25, t10))] : 0.0), ((t26 < uniforms.u2) ? buffer1[(t24 + min(t26, t10))] : 0.0), ((t27 < uniforms.u2) ? buffer1[(t24 + min(t27, t10))] : 0.0));
    uint v8 = 0u;
    while ((v8 < uniforms.u2))
    {
        ...
        uint t36 = (t32 + 2u);
        uint t37 = (t32 + 3u);
        v0 = vec4(((t33 < uniforms.u2) ? buffer0[(t34 + min(t33, t10))] : 0.0), ((t35 < uniforms.u2) ? buffer0[(t34 + min(t35, t10))] : 0.0), ((t36 < uniforms.u2) ? buffer0[(t34 + min(t36, t10))] : 0.0), ((t37 < uniforms.u2) ? buffer0[(t34 + min(t37, t10))] : 0.0));
        uint t38 = (t31 + t2);
        uint t39 = (t38 + 0u);
        ...
        uint t42 = (t38 + 2u);
        uint t43 = (t38 + 3u);
        v4 = vec4(((t39 < uniforms.u2) ? buffer1[(t40 + min(t39, t10))] : 0.0), ((t41 < uniforms.u2) ? buffer1[(t40 + min(t41, t10))] : 0.0), ((t42 < uniforms.u2) ? buffer1[(t40 + min(t42, t10))] : 0.0), ((t43 < uniforms.u2) ? buffer1[(t40 + min(t43, t10))] : 0.0));
        uint t44 = (t31 + t19);
        uint t45 = (t44 + 0u);
        ...
        uint t48 = (t44 + 2u);
        uint t49 = (t44 + 3u);
        v5 = vec4(((t45 < uniforms.u2) ? buffer1[(t46 + min(t45, t10))] : 0.0), ((t47 < uniforms.u2) ? buffer1[(t46 + min(t47, t10))] : 0.0), ((t48 < uniforms.u2) ? buffer1[(t46 + min(t48, t10))] : 0.0), ((t49 < uniforms.u2) ? buffer1[(t46 + min(t49, t10))] : 0.0));
        uint t50 = (((gl_LocalInvocationIndex / 32u) % 1u) * 32u);
        uint t51 = ((t50 + 0u) * 24u);
        vec2 sgm8 = vec2(s0[((t51 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t51 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t52 = ((t50 + 8u) * 24u);
        vec2 sgm9 = vec2(s0[((t52 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t52 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t53 = ((t50 + 16u) * 24u);
        vec2 sgm10 = vec2(s0[((t53 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t53 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t54 = ((t50 + 24u) * 24u);
        vec2 sgm11 = vec2(s0[((t54 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t54 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t55 = (((gl_LocalInvocationIndex / 32u) / 1u) * 16u);
        uint t56 = (768u + t55);
        vec2 sgm12 = vec2(s0[((t56 + 0u)) + sgmRow * (72u) + sgmColumn], s0[((t56 + 0u)) + sgmRow * (72u) + sgmColumn + 1u]);
        vec2 sgm13 = vec2(s0[((t56 + 8u)) + sgmRow * (72u) + sgmColumn], s0[((t56 + 8u)) + sgmRow * (72u) + sgmColumn + 1u]);
        ...
        vec2 sgm14 = vec2(s0[((t51 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t51 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        vec2 sgm15 = vec2(s0[((t52 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t52 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        vec2 sgm16 = vec2(s0[((t53 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t53 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        vec2 sgm17 = vec2(s0[((t54 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t54 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t57 = (1344u + t55);
        vec2 sgm18 = vec2(s0[((t57 + 0u)) + sgmRow * (72u) + sgmColumn], s0[((t57 + 0u)) + sgmRow * (72u) + sgmColumn + 1u]);
        vec2 sgm19 = vec2(s0[((t57 + 8u)) + sgmRow * (72u) + sgmColumn], s0[((t57 + 8u)) + sgmRow * (72u) + sgmColumn + 1u]);
        for (uint sgm0k = 0u; sgm0k < 8u; ++sgm0k)
        {
    ...
    uint t58 = (((gl_LocalInvocationIndex / 32u) % 1u) * 32u);
    uint t59 = (t5 + t58);
    uint t60 = (t59 + 0u);
    uint t61 = (t60 + 8u);
    uint t62 = (((gl_LocalInvocationIndex / 32u) / 1u) * 16u);
    uint t63 = (t14 + t62);
    uint t64 = (t63 + 0u);
    uint t65 = (t64 + 8u);
    ...
    if ((!(t66)))
    {
        ...
        {
            buffer2[((t69 * uniforms.u1) + t70)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t68)];
        }
        uint t71 = (t67 + 32u);
        uint t72 = (t60 + (t71 / 8u));
        uint t73 = (t64 + (t71 % 8u));
        ...
        {
            buffer2[((t72 * uniforms.u1) + t73)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t71)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t76)))
    {
        ...
        {
            buffer2[((t79 * uniforms.u1) + t80)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t78)];
        }
        uint t81 = (t77 + 32u);
        uint t82 = (t60 + (t81 / 8u));
        uint t83 = (t74 + (t81 % 8u));
        ...
        {
            buffer2[((t82 * uniforms.u1) + t83)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t81)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t94)))
    {
        ...
        {
            buffer2[((t97 * uniforms.u1) + t98)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t96)];
        }
        uint t99 = (t95 + 32u);
        ...
        {
            buffer2[((t100 * uniforms.u1) + t101)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t99)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t112)))
    {
        ...
        {
            buffer2[((t115 * uniforms.u1) + t116)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t114)];
        }
        uint t117 = (t113 + 32u);
        ...
        {
            buffer2[((t118 * uniforms.u1) + t119)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t117)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t130)))
    {
        ...
        {
            buffer2[((t133 * uniforms.u1) + t134)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t132)];
        }
        uint t135 = (t131 + 32u);
        ...
        {
            buffer2[((t136 * uniforms.u1) + t137)] = s0[((1920u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t135)];
        }
    }
    memoryBarrierShared();
    barrier();
