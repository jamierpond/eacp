...
void main()
{
    ...
    uint t12 = (t3 + 2u);
    uint t13 = (t3 + 3u);
    v0 = vec4(((t4 < uniforms.u2) ? buffer0[(t9 + min(t4, t10))] : 0.0), ((t11 < uniforms.u2) ? buffer0[(t9 + min(t11, t10))] : 0.0), ((t12 < uniforms.u2) ? buffer0[(t9 + min(t12, t10))] : 0.0), ((t13 < uniforms.u2) ? buffer0[(t9 + min(t13, t10))] : 0.0));
    uint t14 = (lid.x + 128u);
    uint t15 = ((t14 % 4u) * 4u);
    uint t16 = (0u + t15);
    uint t17 = (t16 + 0u);
    ...
    uint t22 = (t16 + 2u);
    uint t23 = (t16 + 3u);
    v1 = vec4(((t17 < uniforms.u2) ? buffer0[(t20 + min(t17, t10))] : 0.0), ((t21 < uniforms.u2) ? buffer0[(t20 + min(t21, t10))] : 0.0), ((t22 < uniforms.u2) ? buffer0[(t20 + min(t22, t10))] : 0.0), ((t23 < uniforms.u2) ? buffer0[(t20 + min(t23, t10))] : 0.0));
    uint t24 = (tgid.x * 64u);
    uint t25 = (t24 + t6);
    uint t26 = (uniforms.u1 - 1u);
    uint t27 = (min(t25, t26) * uniforms.u2);
    v4 = vec4(((t4 < uniforms.u2) ? buffer1[(t27 + min(t4, t10))] : 0.0), ((t11 < uniforms.u2) ? buffer1[(t27 + min(t11, t10))] : 0.0), ((t12 < uniforms.u2) ? buffer1[(t27 + min(t12, t10))] : 0.0), ((t13 < uniforms.u2) ? buffer1[(t27 + min(t13, t10))] : 0.0));
    uint t28 = (t24 + t18);
    uint t29 = (min(t28, t26) * uniforms.u2);
    v5 = vec4(((t17 < uniforms.u2) ? buffer1[(t29 + min(t17, t10))] : 0.0), ((t21 < uniforms.u2) ? buffer1[(t29 + min(t21, t10))] : 0.0), ((t22 < uniforms.u2) ? buffer1[(t29 + min(t22, t10))] : 0.0), ((t23 < uniforms.u2) ? buffer1[(t29 + min(t23, t10))] : 0.0));
    uint v8 = 0u;
    while ((v8 < uniforms.u2))
    {
        ...
        uint t39 = (t35 + 2u);
        uint t40 = (t35 + 3u);
        v0 = vec4(((t36 < uniforms.u2) ? buffer0[(t37 + min(t36, t10))] : 0.0), ((t38 < uniforms.u2) ? buffer0[(t37 + min(t38, t10))] : 0.0), ((t39 < uniforms.u2) ? buffer0[(t37 + min(t39, t10))] : 0.0), ((t40 < uniforms.u2) ? buffer0[(t37 + min(t40, t10))] : 0.0));
        uint t41 = (t34 + t15);
        uint t42 = (t41 + 0u);
        ...
        uint t45 = (t41 + 2u);
        uint t46 = (t41 + 3u);
        v1 = vec4(((t42 < uniforms.u2) ? buffer0[(t43 + min(t42, t10))] : 0.0), ((t44 < uniforms.u2) ? buffer0[(t43 + min(t44, t10))] : 0.0), ((t45 < uniforms.u2) ? buffer0[(t43 + min(t45, t10))] : 0.0), ((t46 < uniforms.u2) ? buffer0[(t43 + min(t46, t10))] : 0.0));
        uint t47 = (t34 + t2);
        uint t48 = (t47 + 0u);
        ...
        uint t51 = (t47 + 2u);
        uint t52 = (t47 + 3u);
        v4 = vec4(((t48 < uniforms.u2) ? buffer1[(t49 + min(t48, t10))] : 0.0), ((t50 < uniforms.u2) ? buffer1[(t49 + min(t50, t10))] : 0.0), ((t51 < uniforms.u2) ? buffer1[(t49 + min(t51, t10))] : 0.0), ((t52 < uniforms.u2) ? buffer1[(t49 + min(t52, t10))] : 0.0));
        uint t53 = (t34 + t15);
        uint t54 = (t53 + 0u);
        ...
        uint t57 = (t53 + 2u);
        uint t58 = (t53 + 3u);
        v5 = vec4(((t54 < uniforms.u2) ? buffer1[(t55 + min(t54, t10))] : 0.0), ((t56 < uniforms.u2) ? buffer1[(t55 + min(t56, t10))] : 0.0), ((t57 < uniforms.u2) ? buffer1[(t55 + min(t57, t10))] : 0.0), ((t58 < uniforms.u2) ? buffer1[(t55 + min(t58, t10))] : 0.0));
        uint t59 = (((gl_LocalInvocationIndex / 32u) % 2u) * 32u);
        uint t60 = ((t59 + 0u) * 24u);
        vec2 sgm16 = vec2(s0[((t60 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t60 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t61 = ((t59 + 8u) * 24u);
        vec2 sgm17 = vec2(s0[((t61 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t61 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t62 = ((t59 + 16u) * 24u);
        vec2 sgm18 = vec2(s0[((t62 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t62 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t63 = ((t59 + 24u) * 24u);
        vec2 sgm19 = vec2(s0[((t63 + 0u)) + sgmRow * (24u) + sgmColumn], s0[((t63 + 0u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t64 = (((gl_LocalInvocationIndex / 32u) / 2u) * 32u);
        uint t65 = (1536u + t64);
        vec2 sgm20 = vec2(s0[((t65 + 0u)) + sgmRow * (72u) + sgmColumn], s0[((t65 + 0u)) + sgmRow * (72u) + sgmColumn + 1u]);
        vec2 sgm21 = vec2(s0[((t65 + 8u)) + sgmRow * (72u) + sgmColumn], s0[((t65 + 8u)) + sgmRow * (72u) + sgmColumn + 1u]);
        vec2 sgm22 = vec2(s0[((t65 + 16u)) + sgmRow * (72u) + sgmColumn], s0[((t65 + 16u)) + sgmRow * (72u) + sgmColumn + 1u]);
        vec2 sgm23 = vec2(s0[((t65 + 24u)) + sgmRow * (72u) + sgmColumn], s0[((t65 + 24u)) + sgmRow * (72u) + sgmColumn + 1u]);
        ...
        vec2 sgm24 = vec2(s0[((t60 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t60 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        vec2 sgm25 = vec2(s0[((t61 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t61 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        vec2 sgm26 = vec2(s0[((t62 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t62 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        vec2 sgm27 = vec2(s0[((t63 + 8u)) + sgmRow * (24u) + sgmColumn], s0[((t63 + 8u)) + sgmRow * (24u) + sgmColumn + 1u]);
        uint t66 = (2112u + t64);
        vec2 sgm28 = vec2(s0[((t66 + 0u)) + sgmRow * (72u) + sgmColumn], s0[((t66 + 0u)) + sgmRow * (72u) + sgmColumn + 1u]);
        vec2 sgm29 = vec2(s0[((t66 + 8u)) + sgmRow * (72u) + sgmColumn], s0[((t66 + 8u)) + sgmRow * (72u) + sgmColumn + 1u]);
        vec2 sgm30 = vec2(s0[((t66 + 16u)) + sgmRow * (72u) + sgmColumn], s0[((t66 + 16u)) + sgmRow * (72u) + sgmColumn + 1u]);
        vec2 sgm31 = vec2(s0[((t66 + 24u)) + sgmRow * (72u) + sgmColumn], s0[((t66 + 24u)) + sgmRow * (72u) + sgmColumn + 1u]);
        for (uint sgm0k = 0u; sgm0k < 8u; ++sgm0k)
        {
    ...
    uint t67 = (((gl_LocalInvocationIndex / 32u) % 2u) * 32u);
    uint t68 = (t5 + t67);
    uint t69 = (t68 + 0u);
    uint t70 = (t69 + 8u);
    uint t71 = (((gl_LocalInvocationIndex / 32u) / 2u) * 32u);
    uint t72 = (t24 + t71);
    uint t73 = (t72 + 0u);
    uint t74 = (t73 + 8u);
    ...
    if ((!(t75)))
    {
        ...
        {
            buffer2[((t78 * uniforms.u1) + t79)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t77)];
        }
        uint t80 = (t76 + 32u);
        uint t81 = (t69 + (t80 / 8u));
        uint t82 = (t73 + (t80 % 8u));
        ...
        {
            buffer2[((t81 * uniforms.u1) + t82)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t80)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t85)))
    {
        ...
        {
            buffer2[((t88 * uniforms.u1) + t89)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t87)];
        }
        uint t90 = (t86 + 32u);
        uint t91 = (t69 + (t90 / 8u));
        uint t92 = (t83 + (t90 % 8u));
        ...
        {
            buffer2[((t91 * uniforms.u1) + t92)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t90)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t95)))
    {
        ...
        {
            buffer2[((t98 * uniforms.u1) + t99)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t97)];
        }
        uint t100 = (t96 + 32u);
        ...
        {
            buffer2[((t101 * uniforms.u1) + t102)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t100)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t105)))
    {
        ...
        {
            buffer2[((t108 * uniforms.u1) + t109)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t107)];
        }
        uint t110 = (t106 + 32u);
        ...
        {
            buffer2[((t111 * uniforms.u1) + t112)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t110)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t139)))
    {
        ...
        {
            buffer2[((t142 * uniforms.u1) + t143)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t141)];
        }
        uint t144 = (t140 + 32u);
        ...
        {
            buffer2[((t145 * uniforms.u1) + t146)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t144)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t173)))
    {
        ...
        {
            buffer2[((t176 * uniforms.u1) + t177)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t175)];
        }
        uint t178 = (t174 + 32u);
        ...
        {
            buffer2[((t179 * uniforms.u1) + t180)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t178)];
        }
    }
    memoryBarrierShared();
    barrier();
    ...
    if ((!(t207)))
    {
        ...
        {
            buffer2[((t210 * uniforms.u1) + t211)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t209)];
        }
        uint t212 = (t208 + 32u);
        ...
        {
            buffer2[((t213 * uniforms.u1) + t214)] = s0[((2688u + ((gl_LocalInvocationIndex / 32u) * 64u)) + t212)];
        }
    }
    memoryBarrierShared();
    barrier();
